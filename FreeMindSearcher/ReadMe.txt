===============================================================================
    アプリケーション : FreeMindSearcher プロジェクトの概要
===============================================================================

この FreeMindSearcher アプリケーションは、AppWizard によって作成されました。

このファイルには、FreeMindSearcher アプリケーションを構成する各ファイルの
内容の概略が記述されています。

FreeMindSearcher.vcproj
...
StdAfx.h, StdAfx.cpp
    これらのファイルは、コンパイル済みヘッダー (PCH) ファイル FreeMindSearcher.pch 
